                    ...
                    <div class="row <?= $count > 0 ? 'mt-1' : '' ?>">
                        <div class="col-3">
                            <label>
                                <input type="checkbox" id="checkbox<?= $checkbox_id ?>" name="products[{{ $count }}][name]"
                                    value="{{ $product }}" class="toggle-fields">
                                {{ $product }}
                            </label>
                        </div>
                        <div id="fields<?= $checkbox_id ?>" class="fields col-9" style="display: none;">
                            <div class="row gap-4">
                                ...
                                <input class="col-3 total-amount" type="text" name="products[{{ $count }}][total_amount]"
                                    placeholder="Total Amount" oninput="calculateTotals()">
                                <input class="col-3 paid-amount" type="text" name="products[{{ $count }}][paid_amount]"
                                    placeholder="Paid Amount" oninput="calculateTotals()">
