...
<script src="{{ asset('assets/admin/libs/ckeditor/multiple_ckeditor.js') }}"></script>
...
<script src="{{ asset('assets/admin/libs/@chenfengyuan/datepicker/datepicker.min.js') }}"></script>
